...
if(PXR_COMPILER_CACHE_NAME STREQUAL "sccache")
    # When using sccache, we want to disable PDB generation to avoid "permission denied" compile errors on program databases
    set(_PXR_CXX_FLAGS "${_PXR_CXX_FLAGS} /Z7")
else()
